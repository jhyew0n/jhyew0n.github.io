...
- 만약 작은 크기의 table을 원하거나 scroll 되기를 원한다면 테이블 아래 코드를 입력. 
~~~
    {:.smaller}
    {:.scroll-table}
~~~
...
<div class="main_center">
    <div><img src= "assets/img/blog/example-content-ii.jpg" style="width: auto; height: 500px;"></div>
    <div><img src="/assets/img/blog/example-content-iii.jpg" style="width: auto; height: 500px;"></div>
